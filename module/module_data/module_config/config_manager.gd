...
## 配置数据
const DefaultConfig: Script = preload("res://addons/godot_system/module/module_data/module_config/default_config.gd")

## 项目设置路径常量
const SETTING_SAVE_PATH: String = "godot_system/module_config/save_path"
const SETTING_AUTO_SAVE_ENABLED: String = "godot_system/module_config/auto_save_enabled"
