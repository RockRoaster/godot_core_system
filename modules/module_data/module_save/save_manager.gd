...
## 存档数据
const GameStateData: Script = preload("res://addons/godot_core_system/modules/module_data/module_save/game_state_data.gd")

## 项目设置路径常量
const SETTING_SAVE_DIR: String = "godot_core_system/module_save/save_directory"
const SETTING_SAVE_EXT: String = "godot_core_system/module_save/save_extension"
const SETTING_MAX_AUTO_SAVES: String = "godot_core_system/module_save/max_auto_saves"
const SETTING_AUTO_SAVE_INTERVAL: String = "godot_core_system/module_save/auto_save_interval"
const SETTING_AUTO_SAVE_ENABLED: String = "godot_core_system/module_save/auto_save_enabled"

## 存档目录
var save_directory: String:
	get: return ProjectSettings.get_setting(SETTING_SAVE_DIR, "user://saves")

## 存档扩展名
var save_extension: String:
	get: return ProjectSettings.get_setting(SETTING_SAVE_EXT, "sav")

## 自动存档间隔（秒）
var auto_save_interval: float:
	get: return ProjectSettings.get_setting(SETTING_AUTO_SAVE_INTERVAL, 300)

## 自动存档最大数量
var max_auto_saves: int:
	get: return ProjectSettings.get_setting(SETTING_MAX_AUTO_SAVES, 3)

## 是否启用自动存档
var auto_save_enabled: bool:
	get: return ProjectSettings.get_setting(SETTING_AUTO_SAVE_ENABLED, true)

## 当前存档
var _current_save: GameStateData = null
### 异步IO管理器
var _io_manager: System.ModuleAsyncIO:
	get: return _system.io_manager
## 自动存档计时器
...
func create_save(save_name: String, callback: Callable = func(_success: bool): pass) -> void:
	...
	# 收集所有可序列化组件的数据
	var serializable_nodes = _system.get_tree().get_nodes_in_group(SerializableComponent.GROUP_NAME)
	var serialized_data = {}
