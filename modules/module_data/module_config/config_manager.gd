...
## 配置数据
const DefaultConfig: Script = preload("res://addons/godot_core_system/modules/module_data/module_config/default_config.gd")

## 项目设置路径常量
const SETTING_SAVE_PATH: String = "godot_core_system/module_config/save_path"
const SETTING_AUTO_SAVE_ENABLED: String = "godot_core_system/module_config/auto_save_enabled"

## 配置文件路径
@export var config_path: String:
	get: return ProjectSettings.get_setting(SETTING_SAVE_PATH, "user://config.cfg")
	set(value): config_path = value

## 是否自动保存
@export var auto_save: bool:
	get: return ProjectSettings.get_setting(SETTING_AUTO_SAVE_ENABLED, true)
	set(value): auto_save = value
